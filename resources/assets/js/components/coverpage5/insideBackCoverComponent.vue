                                ...
                                <div class="inner_fc_bottom" v-if="!footerCondition">
                                    <div class="col-sm-12 col-md-12 col-xs-12">
                                        ...
                                        <div class="col-sm-4 col-xs-4 col-md-4 ">
                                            ...
                                            <h3 v-if="extraAddress.length > 0" v-for="(address, index) in extraAddress" :key="index">
                                                {{ address.address ? address.address + ',' : isSaved ? '' :'City'  }}
                                                {{ address.city ? address.city + ',' : isSaved ? '' :'City'  }}
                                            ...
                                            <h3>{{phone ? phone  : isSaved ? '' :'xxxxxxxxxx or' }} {{phone && tollFreeNumber ? 'or' : ''}} {{tollFreeNumber ? tollFreeNumber : isSaved ? '' : 'xxxxxxxxxx' }}</h3>
    ...
    export default {
        ...
        data () {
            return {
                ...
                directNumber: '',
                nameOrCompanyName: '',
                step3Image : 'magazine/images/ibc_book4.jpg',
            ...
            saveInsideBackCover (types) {
                ...
                .then(response => {
                    if (types === 2) {
                        ...
                        this.$router.push('/cover5/backCover');
                    } else {
