            ...
            <div class="padding_left_right">
                <form >
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-xs-9 col-md-9 col-sm-9 pull-left ">
                                <div class="preview_img_div book_cover3 book3_innerfc book5_ifc" v-if="withPhoto !== 'with_pdf'">
                                    <img src="magazine/images/ifc_innerimg.jpg" alt="" title="" style="width:100%;">
                                    <div class="col-sm-12 col-xs-12 col-md-12 inner_book5_detail ">
                                        <div class="col-sm-6 col-md-6 col-xs-6">
                                            <p v-html="personDetail" style="margin-bottom:0px;"></p>
                                    ...
                                    <div class="inner_fccover2">
                                        ...
                                        <div>
                                            <img src="magazine/images/ifc_book5_bottom.jpg" alt="" title="" style="width:100%;">
                                        </div>
                                    </div>
                                </div>
                                <div v-if="withPhoto === 'with_pdf'">
                    ...
                    <div class="form-group">
                        ...
                        <!-- <router-link to="insideBackCover" class="green_btn submit_btn" tyle="margin-right: 0px;"><span  @click="saveInsideFrontCover">Approve Step 2. Go to Step 3</span></router-link> -->
                    </div>
        ...
        export default {
            ...
            data () {
                return {
                    ...
                    companyTagLine: '',
                    personDetail: '<p>Your style of travel is entirely a reflection of you. Perhaps you’re drawn to the thrill of big cities brimming with art and culture. Maybe you’re craving an island escape to blissful beaches or a luxury lodge in the heart of the wilderness.</p><p> We are proud to share our 2019 Hotels & Resorts Collection, showcasing all the ways we can tailor your vacation with the right accommodations. Every one of more than 1,000 distinctive hotels, resorts, lodges, spas and unique places to stay has been handpicked based on exceptional location, high-end amenities and service beyond compare. </p>',
                    ...
                    .then(response => {
                       if (response.data.success === true) {
                            ...
                            if (type === 2) {
                                ...
                                this.$router.push('/cover5/insideBackCover')    
                            } else {
