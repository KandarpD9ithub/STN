                        ...
                        <div class="row">
                            <div>
                                ...
                                <div class="col-xs-12 col-md-6 col-sm-6">
                                    <div class="row">
                                        <div class="col-xs-12 col-md-6 col-sm-6 full_width">
                                            <input type="text" maxlength="17" name="" v-model="locationPhone" class="form-control" id="" placeholder="Phone" >
                                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                         ...
                         <div class="col-xs-9 col-md-9 col-sm-9 pull-left">
                            <div class="preview_img_div book_4ifc" v-if="withPhoto !== 'with_pdf'">
                                <div class="inner_front_cover">
                                    <h2>YOUR PASSION FOR TRAVEL <br/>IS OUR INSPIRATION</h2>
                                ...
                                <div class="inner_fc_bottom" v-if="!footerCondition">
                                    <div class="col-sm-12 col-md-12 col-xs-12">
                                        <!-- address 1 -->
                                        <div v-if="extraAddress.length === 0">
                                            ...
                                            <div class="col-sm-4 col-xs-4 col-md-4 ">
                                                ...
                                                <h3>{{ locationPhone ? locationPhone : isSaved ? '' :'xxx.xxx.xxxx'  }}<br class="responsive_br"></h3>
                                                <!-- loop for Extra Address -->
                                                <!-- loop end -->
                                            </div>
                                            <div class="col-sm-4 col-xs-4 col-md-4 ">
                                                <h3>{{phone ? phone : isSaved ? '' :'XXXXXXXXXX' }} {{phone && tollFreeNumber ? '': ''}}</h3>
                                                <h3>{{tollFreeNumber ? tollFreeNumber : isSaved ? '' : 'XXXXXXXXXX' }}<br class="responsive_br"></h3>
                                        ...
                                        <div v-if="extraAddress.length === 1">
                                            <div class="col-sm-4 col-xs-4 col-md-4 ">
                                                <div class="inner_fc_bottom_img">
                                                    <!-- <img src="magazine/images/image1.jpg" alt="" title="" > -->
                                                    <img :src="logoImage ? logoImage : ''"  alt="" title="" >
                                            ...
                                            <div class="col-sm-4 col-xs-4 col-md-4 ">
                                                ...
                                                <h3>{{phone ? phone : isSaved ? '' :'XXXXXXXXXX' }} {{phone && tollFreeNumber ? '': ''}}</h3>
                                                <h3>{{tollFreeNumber ? tollFreeNumber : isSaved ? '' : 'XXXXXXXXXX' }}</h3>
                                            </div>
                                            <div class="col-sm-4 col-xs-4 col-md-4 ">
                                                <!-- loop for Extra Address -->
                                                <div v-if="extraAddress.length == 1" v-for="(address, index) in extraAddress" :key="index">
                                        ...
                                        <div v-if="extraAddress.length === 2">
                                            <div class="col-sm-4 col-xs-4 col-md-4 ">
                                                <div class="inner_fc_bottom_img">
                                                    <!-- <img src="magazine/images/image1.jpg" alt="" title="" > -->
                                                    <img :src="logoImage ? logoImage : ''"  alt="" title="" >
                                        ...
                                        <div v-if="extraAddress.length === 3">
                                            <div class="col-sm-4 col-xs-4 col-md-4 ">
                                                <div class="inner_fc_bottom_img">
                                                    <!-- <img src="magazine/images/image1.jpg" alt="" title="" > -->
                                                    <img :src="logoImage ? logoImage : ''"  alt="" title="" >
    ...
    export default {
        ...
        methods: {
                ...
                .then(response => {
                   if (response.data.success === true) {
                        ...
                        if (type === 2) {
                            ...
                            this.$router.push('/cover3/insideBackCover')    
                        } else {
                            this.PUSH_MESSAGE('Inside Front Cover Saved!');
                            var win = window.open(this.$url + 'preview/book3' + '/2/' + this.$session.get('userId') , '_blank');
                            win.focus();
                        }
            ...
            setAsBook1 (responseData) {
                ...
                this.companyTagLine = responseData.companyTagLine
                this.location = responseData.location
                this.locationPhone = responseData.locationPhone ? responseData.locationPhone : ''
                this.extraAddress = responseData.extraAddress ? responseData.extraAddress : []
                this.withFooterImage = responseData.withFooterImage ? responseData.withFooterImage : false
                this.footerImage = responseData.footerImage ? responseData.footerImage : ''
                this.footerCondition = responseData.footerCondition ? responseData.footerCondition : false
