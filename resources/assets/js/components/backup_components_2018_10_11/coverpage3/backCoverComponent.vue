                    ...
                    <div class="row">
                        <div>
                            <div class="col-xs-12 col-md-12 col-sm-12">
                                ...
                                <button type="button" name="" @click="storeBackCover(1)" value="Preview" class="green_btn submit_btn" style="margin-right: 0px;" ><span>Save</span></button>
                    ...
                    <div class="row">
                        <div class="col-xs-9 col-md-9 col-sm-9 main_preview pull-left ">
                            <div class="preview_img_div book_3_preview">
                                <div class="">
                                    <img src="magazine/images/book4_topwhite.jpg" alt="" title="" style="width:100%;">
                                </div>
                                <div class="inner_fccover2">
                                    <div class="col-sm-7 col-xs-7 col-md-7 book4_ifc_left" v-if="!footerCondition">
                                    ...
                                    <div class="col-sm-7 col-xs-7 col-md-7 book4_ifc_left" v-if="footerCondition" style="padding:0px;">
                                        <div class="col-sm-12 col-md-12 col-xs-12 pull-left left_sideback book1_backcover_height footer_images" style="">
                                            <img :src="footerImage" alt="" style="width:100%; height:auto;">
                                        </div>
                                    </div>


                                    <div class="col-sm-5 col-xs-5 col-md-5 book4_ifc_right">
    ...
    export default {
        ...
        methods: {
            ...
            setFormData (responseData, responseData2) {
                ...
                this.extraAddress = responseData2.extraAddress ? responseData2.extraAddress : responseData.extraAddress
