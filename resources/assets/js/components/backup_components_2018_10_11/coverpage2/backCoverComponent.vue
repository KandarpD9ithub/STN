                        ...
                        <div class="col-xs-9 col-md-9 col-sm-9 main_preview pull-left ">
                            <div class="preview_img_div">
                                ...
                                <div class="col-sm-12 col-md-12 col-xs-12">
                                    <div class="inner_book2">
                                        <h2><img src="magazine/images/bc_logo2.jpg" alt="" title=""></h2>
                                        <h3>By {{ nameOrCompanyName ? nameOrCompanyName + ',' : isSaved ? '' : 'Agency Name' }} </h3>
                                    </div>
                                </div>
                                <div class="bottom_backcover">
                                    <img src="magazine/images/backcover2.jpg" alt="" title="">
                                </div>
                            </div>
                        </div>
