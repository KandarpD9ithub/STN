                            ...
                            <div class="col-xs-12 col-md-6 col-sm-6">
                                <div class="row">
                                    <div class="col-xs-12 col-md-6 col-sm-6 full_width">
                                        <input type="text" name="" maxlength="13" v-model="locationPhone" class="form-control" id="" placeholder="Phone" >
                                    </div>
                        ...
                        <div class="row">
                            <div>
                                ...
                                <div class="col-xs-12 col-md-6 col-sm-6">
                                    <div class="row">
                                        <div class="col-xs-12 col-md-6 col-sm-6 full_width">
                                            <input type="text" name="" maxlength="13" v-model="input.locationPhone" class="form-control" id="" placeholder="Phone" >
                                        </div>
                                        <div class="col-xs-12 col-md-3 col-sm-3 col-sm-offset-1">   
                        ...
                        <div>
                            <div class="col-xs-12 col-md-12 col-sm-12">
                                ...
                                <div style="padding-left:15px; float:left;">
                                    ...
                                    <label for="footer"> footer image</label>
                                </div>
                            ...
                            <div class="preview_img_div">
                                <div class="col-sm-12 col-xs-12 col-md-12" v-if="!footerCondition">
                                   <div class="col-sm-12 col-md-12 col-xs-12 pull-left left_sideback book1_backcover_height">
                                        ...
                                        <h3>{{ phone ? phone : isSaved ? '' : 'xxxxxxxxxx' }} {{phone && tollFreeNumber ? 'or' : ''}}</h3>
