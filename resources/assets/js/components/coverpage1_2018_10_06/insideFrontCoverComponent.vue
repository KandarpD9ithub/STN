                ...
                <div v-if="withPhoto !== 'with_pdf'">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div>
                                <div class="col-xs-12 col-md-6 col-sm-6">
                                    <input type="text" name="" v-model="phone" maxlength="13" id="" class="form-control" placeholder="Local Phone Number" >
                                </div>
                                <div class="col-xs-12 col-md-6 col-sm-6">
                                    <input type="text" name="" v-model="tollFreeNumber" maxlength="13" id="" class="form-control" placeholder="Toll-Free Phone Number" >
                                </div>
                            </div>
                        </div>
                    </div>
