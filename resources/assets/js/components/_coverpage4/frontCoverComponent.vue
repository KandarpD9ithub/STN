        ...
        <div class="padding_left_right">
            ...
            <form>
                ...
                <div class="form-group">
                    ...
                    <p class="magin_bottom_70">Customize the front cover with your company logo and name that will appear above the masthead. </p>
                </div>
                <div class="form-group">
                    <input type="text" data-vv-name="title" v-model="title" :class="{'form-control': true, 'alert-danger': errors.has('title'), 'step_input': true }" placeholder="For example : ABC Trvel - John Smith">
                    <!-- <span v-show="errors.has('title')" class="color-red">{{ errors.first('title') }}</span> -->
                </div>
                <div class="form-group">
                    <input type="text" v-model="subTitle"  class="form-control" placeholder="Member / Affiliate Name">
                </div>
                <div class="form-group">
                    <div class="row">
                        <div class="col-xs-9 col-md-9 col-sm-9 pull-left ">
                            <div class="full_img magin_bottom_70 step1_bg_img book_2_fcbg book3_fcbg">
                        ...
                        <div class="col-xs-3 col-md-3 col-sm-3 approve_btn pull-right">
                            <div class="checkbox">
                                <label ><input type="checkbox" :checked="includeLogo" @click="includeLogo = !includeLogo" value="">Check here to include logo on cover. Note: Logo for front cover must be horizontal in dimension </label>
                ...
                this.$validator.validateAll().then(result => {
                    if(result) {
                        ...
                        .then(response => {
                            ...
                            if (type === 2) {
                                this.$store.state.successMessage.push({message: 'Front Cover Saved and Aproved!'})
                                this.$router.push('/cover4/insideFrontCover')    
                            } else {
                                this.$store.state.successMessage.push({message: 'Front Cover Saved!'})
                            }
