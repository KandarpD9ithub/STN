                    ...
                    <div class="row">
                        <div class="inner_step3">
                            <div class="col-xs-12 col-md-5 col-sm-6">
                                <div class="preview_img_div"><img src="magazine/images/ibc4.jpg" alt="" title=""></div>
...
import { mapState, mapMutations, mapActions } from 'vuex';
    export default {
        ...
        methods: {
            ...
            changeImage (image) {
                if (image === 1) {
                    this.step3Image = 'magazine/images/ibc_book4.jpg';
            ...
            saveInsideBackCover (types) {
                ...
                .then(response => {
                    if (types === 2) {
                        ...
                        this.$router.push('/cover4/backCover');
                    } else {
