                            ...
                            <div class="col-xs-12 col-md-5 col-sm-6">
                                ...
                                <div class="form-group col-sm-12">
                                    <label class="radio-inline">
                                        ...
                                        <input type="radio" name="image" @click="changeImage(2)" :checked="checkOption2" value="">Upload PDF Artwork
                                    </label>
                                    <!-- <button v-if="isShowButton" type="button" class="green_btn submit_btn" data-toggle="modal" data-target="#myModal">Choose Image</button> -->
                                     <div class="row">
                                        <div class="checkbox" v-if="option2" style="margin-bottom:0px;">
                                            ...
                                            <label style="padding:0px; padding-bottom:10px;">Check here if you are uploading your own artwork. <br> Note: High resolution PDF only.</label>
                                            <div >
                                                <input type="file" name="pdf" id="" ref="fileInput" v-on:change="onImageChange" v-validate="'ext:pdf'">
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-xs-9 col-md-9 col-sm-9 pull-left " v-if="!option2">
                            <div class="preview_img_div inside_bc book_3">
                                <div>
                                ...
                                <div class="inner_fc_bottom">
                                    <div class="col-sm-12 col-md-12 col-xs-12">
                                        ...
                                        <div class="col-sm-4 col-xs-4 col-md-4 ">
                                            <h3><b>{{nameOrCompanyName ? nameOrCompanyName : isSaved ? '' : 'Company Name'}}</b></h3>
