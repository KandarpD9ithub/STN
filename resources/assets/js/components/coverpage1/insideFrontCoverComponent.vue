                                    ...
                                    <div class="col-sm-12 col-md-12 col-xs-12">
                                        ...
                                        <div v-if="extraAddress.length === 0">
                                            ...
                                            <div class="col-sm-4 col-xs-4 col-md-4 ">
                                                ...
                                                <h3>{{tollFreeNumber ? tollFreeNumber : isSaved ? '' : 'XXXXXXXXXX' }}</h3><br v-if="phone && tollFreeNumber" class="responsive_br">
                ...
                .then(response => {
                   if (response.data.success === true) {
                        ...
                        if (type === 2) {
                            ...
                            // Open preview
                            var win = window.open(this.$url + 'preview/book1' + '/2/' + this.$session.get('userId') , '_blank');
                            win.focus();
                        }
