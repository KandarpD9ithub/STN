                    ...
                    <div class="row">
                        <div class="col-xs-9 col-md-9 col-sm-9 pull-left " v-if="!option2">
                            <div class="preview_img_div inside_bc">
                                ...
                                <div class="inner_fc_bottom" v-if="!footerCondition" style="border-top:3px double #000;">
            ...
            saveInsideBackCover (types) {
                ...
                .then(response => {
                    if (types === 2) {
                        ...
                        // and p1 == page 1
                        var win = window.open(this.$url + 'preview/book1' + '/3/' + this.$session.get('userId') , '_blank');
                        win.focus();
                    }
                })
                .catch(errorResponse => {
