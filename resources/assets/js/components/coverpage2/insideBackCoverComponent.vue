                    ...
                    <div class="row">
                        <div class="inner_step3">
                            <div class="col-xs-12 col-md-5 col-sm-6">
                                <div class="preview_img_div"><img src="magazine/images/ibc2.jpg" alt="" title=""></div>
                            ...
                            <div class="col-xs-12 col-md-5 col-sm-6">
                                <div class="preview_img_div">
                                    <img :src="showHidePdfPageImage ? showHidePdfPageImage : 'magazine/images/insidebackpdf.pdf'" alt="" srcset=""  width="100%" height="200">
                                    ...
                                    <!-- <button v-if="isShowButton" type="button" class="green_btn submit_btn" data-toggle="modal" data-target="#myModal">Choose Image</button> -->
                                     <div class="row">
                                        <div class="checkbox" v-if="option2" style="margin-bottom:0px;">
                                            ...
                                            <label style="padding:0px; padding-bottom:10px;">Check here if you are uploading your own artwork. <br> Note: High resolution Artwork Image only.</label>
                                            <div >
                                                <input type="file" name="artwork" id="" ref="fileInput" v-on:change="onImageChange" v-validate="'ext:jpg,png,jpeg'">
    ...
    export default {
        ...
        data () {
            return {
                ...
                directNumber: '',
                nameOrCompanyName: '',
                step3Image : 'magazine/images/ibc_book2.jpg',
        ...
        methods: {
            ...
            changeImage (image) {
                if (image === 1) {
                    this.step3Image = 'magazine/images/ibc_book2.jpg';
            ...
            saveInsideBackCover (types) {
                ...
                .then(response => {
                    if (types === 2) {
                        ...
                        this.$router.push('/cover2/backCover');
                    } else {
                        this.PUSH_MESSAGE('Inside Back Cover Saved!')
                        // Open preview
                                var win = window.open(this.$url + 'preview/book2' + '/3/' + this.$session.get('userId') , '_blank');
                                win.focus();
                    }
                })
                .catch(errorResponse => {
            ...
            setFormData (responseData, responseData2) {
                ...
                this.step3Image = responseData.step3Image ? responseData.step3Image : 'magazine/images/ibc_book2.jpg'
                this.option2Image = responseData.step3Image ? responseData.step3Image : 'magazine/images/ibc_book2.jpg'
                if (this.option2Image !== 'magazine/images/inner_bc2.jpg' && this.option2Image !== 'magazine/images/ibc_book2.jpg') {
                    this.isShowButton = true
                }
