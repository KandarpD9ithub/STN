                ...
                <div v-if="withPhoto !== 'with_pdf'">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div>
                                <div class="col-xs-12 col-md-6 col-sm-6">
                                    <input type="text" name="" maxlength="17" v-model="phone" id="" class="form-control" placeholder="Local Phone Number" >
                                </div>
                                <div class="col-xs-12 col-md-6 col-sm-6">
                                    <input type="text" name="" maxlength="17" v-model="tollFreeNumber" id="" class="form-control" placeholder="Toll-Free Phone Number" >
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-xs-9 col-md-9 col-sm-9 pull-left ">
                                <div class="preview_img_div book_cover2" v-if="withPhoto !== 'with_pdf'">
                                    <div class="inner_fccover2">
                                        <img src="magazine/images/book2_fc.jpg" alt="" title="">
                                        <div class="inner_front_cover">
                                            <div class="">
                                                <h2>Travel with <em>Intent</em></h2>
                                                <div class="col-sm-7 col-xs-7 col-md-7">
                                                    <div class="inner_fcover">
                                                        <div class=" inner_fc2_pic" v-if="withPhotoImage && withPhoto == 'with_photo'">
                                                            <img :src="withPhotoImage ? withPhoto === 'with_no_photo' ? '' : withPhotoImage : 'magazine/images/person_photo.png'"  alt="" title="" >
                                                        </div>
                                                ...
                                                <div class="col-sm-4 col-xs-4 col-md-4 right_book2_address">
                                                    <div class="inner_fc_bottom" v-if="!footerCondition">
                                                        <div class="inner_fc_bottom_img">
                                                            <img :src="logoImage ? logoImage : ''"  alt="" title=""  style="margin-bottom:10px;">
                                                        ...
                                                        <div v-if="extraAddress.length > 0" v-for="(address, index) in extraAddress" :key="index">
                                                        ...
                                                        <!-- loop end -->
                                                        <h3>{{phone ? phone : isSaved ? '' :'XXXXXXXXXX' }} {{phone && tollFreeNumber ? '' : ''}}   {{tollFreeNumber ? tollFreeNumber : isSaved ? '' : 'XXXXXXXXXX' }}</h3><br class="responsive_br">
                                                        <h3>{{website ? website : isSaved ? '' : 'www.example.org' }}</h3>
                                                        <h3>{{email ? email : isSaved ? '' : 'example@example.com' }}</h3><br class="responsive_br">
                                                        <h3>{{ memberCSTNumber ? memberCSTNumber : '' }}</h3>
                                                        <h3 class="tag_line_text">{{companyTagLine ? companyTagLine : ''}}</h3>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- if Footer image selected -->
                                        <div class="preview_footer_images inner_fc_bottom " v-if="footerCondition" style="padding:0px; margin-top:0px; border:none;">
                        ...
                        <div class="col-xs-3 col-md-3 col-sm-3 approve_btn pull-right">
                            <div>
                                <button type="button" name="" @click="saveInsideFrontCover(1)" value="Preview" class="green_btn submit_btn" style="margin-right: 0px;" ><span>Save & Preview</span></button>
        ...
        methods: {
                ...
                .then(response => {
                   if (response.data.success === true) {
                        ...
                        if (type === 2) {
                            ...
                            this.$router.push('/cover2/insideBackCover')    
                        } else {
                            this.PUSH_MESSAGE('Inside Front Cover Saved!');
                            // Open preview
                            var win = window.open(this.$url + 'preview/book2' + '/2/' + this.$session.get('userId') , '_blank');
                            win.focus();
                        }
            ...
            addRow() {
                ...
                if (this.extraAddress.length <= 2) {
                    ...
                    alert('Maximum 4 address allowed ! Please upload own footer image for more than 4 address.')
                }
            },
            deleteRow(index) {
                // 
