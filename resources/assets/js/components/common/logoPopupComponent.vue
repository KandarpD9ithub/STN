        ...
        <div class="modal-body">
            <div class="form-group">
                <div v-if="libraryImages.length > 0" v-for="(lib, index) in libraryImages" :key="index">
                    <div class="col-sm-3 col-md-3 col-xs-6" v-if="lib.image_type === 'logo'">
                        <div class="inner_img">
                            <img :src="lib.image" alt="" title="" @click="$parent.changeLogo(lib.image, lib.id)"  class="btn btn-default" data-dismiss="modal">
                        </div>
                    </div>
                </div>
            </div>  
